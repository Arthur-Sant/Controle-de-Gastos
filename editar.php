...
if(isset($_POST["atualizar"])){
    ...
    if($us->SENHA == $deu){
        ...
        echo "<script>
alert('Sua senha atual está errada!!!')
</script>";
    }
}
...
<form action="editar.php" method="post">
                <div class="form-group">
                    <label for="senha">Sua senha atual é:</label>
                    <input type="password" name="senha" class="form-control" id="senha" required>
                </div>
                <div class="form-group">
                    <label for="nsenha">Dígite sua nova senha:</label>
                    <input type="password" name="nsenha" class="form-control" id="nsenha" required>
                </div>
                <div>
                    <button class="btn btn-success" name="atualizar" type="submit" style="background-color: #ADBABD;
                    border-color: black;">Atualizar</button>
                </div>
</form>
            </div>
